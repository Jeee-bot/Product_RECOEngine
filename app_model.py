...
def predict_recommendation():
    ...
    if request.method == 'POST':
        ...
        user_reco_file = open('./data/user.pkl', 'rb')
        ...
        sentiment_model_file = open('./data/LR_model.pkl', 'rb')
        ...
        tfidf_features = tfidf_vector.transform(product_review_data['clean_text'])
